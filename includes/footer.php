    ...
    <footer class="w-full bg-white pt-5 pb-3 mt-5 border-t border-gray-200 relative overflow-hidden z-10">
        <div class="w-full px-6 md:px-8 mx-auto relative">
            ...
            <div class="md:col-span-1 md:pr-4 md:border-r border-gray-100/80">
                ...
                <div class="flex items-start gap-3 text-gray-500 text-[13.5px] font-medium mb-5">
                    ...
                    <span>College Road,<br>Civil Lines, Sheikhupura</span>
                </div>
                ...
                <div class="flex items-center gap-3 mb-3 md:mb-0">
                    ...
                    <a href="https://www.youtube.com/@GCbSkp/" target="_blank" class="w-[32px] h-[32px] rounded-full border-[1.5px] border-[#a60b26] text-[#a60b26] flex items-center justify-center hover:bg-[#a60b26] hover:text-white transition-colors">
                        <svg class="w-[14px] h-[14px]" fill="currentColor" viewBox="0 0 24 24"><path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.5 12 3.5 12 3.5s-7.505 0-9.377.55a3.016 3.016 0 0 0-2.122 2.136C0 8.082 0 12 0 12s0 3.918.501 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.55 9.377.55 9.377.55s7.505 0 9.377-.55a3.016 3.016 0 0 0 2.122-2.136C24 15.918 24 12 24 12s0-3.918-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/></svg>
                    </a>
                </div>
            </div>
    ...
    <?php endif; ?>
    <!-- Bootstrap JS (Local for offline support) -->
