...
<div class="max-w-[1024px] w-[88%] mx-auto mt-10 mb-16 relative z-10">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        ?>
            <div class="bg-white p-6 rounded shadow-md border border-gray-200 flex flex-col items-center text-center group">
    ...
    <?php if(empty($downloads)): ?>
        <div class="bg-white rounded shadow-md border border-gray-200 p-16 text-center max-w-2xl mx-auto">
